...
Original skill profile switching concept and activate-profile.js by Rick Moore. Expanded to support agents, commands, and MCP server configs by Tyson Heim.
